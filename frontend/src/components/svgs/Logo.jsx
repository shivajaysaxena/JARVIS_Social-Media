const LogoSvg = (props) => {
    return (
        <svg aria-hidden='true' viewBox='0 0 24 24' {...props}><g id="SVGRepo_bgCarrier" strokeWidth="0" {...props}></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier">
